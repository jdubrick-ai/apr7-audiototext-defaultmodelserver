...
3) Access the `workbench` named `apr7-audiototext-defaultmodelserver-notebook`.
...
5) In the terminal, run `cd apr7-audiototext-defaultmodelserver` to navigate to your sample app's directory.
